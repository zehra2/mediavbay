...
if (isset($_POST['submit'])) {
  ...
  $structure = "
    ...
    --
    ALTER TABLE `system_options`
      MODIFY `option_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3278;
          ...
          <div class="content-wrapper">
            ...
            <div class="row mb-4">
              <div class="form-group col-12">
                <label for="purchase_code">Your Purchase Code | <a href="https://doniaweb.com" target="_blank">Licensed By DoniaWeB</a></label>
                <input type="text" name="purchase_code" id="purchase_code" class="form-control" placeholder="Enter DoniaWeB">
                <div class="invalid-feedback">
